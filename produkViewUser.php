...
<html>
    ...
    <body>
        ...
        <div class="navbar">
            ...
            <a style="float:right" class="img-menu" href="login.php"><img src="profile.png" /></a>
            ...
            <div class="row">
                ...
                <div class="column  <?php echo $dataSeller[1]; ?>">
                    <div class="content">
                        ...
                        <p class="price">Rp. <?php echo $dataSeller[2];?></p>
                        <button class="add-to-cart"><a href="#"; style="text-decoration: none; color: white;">Add to Cart</a></button>
                    </div>
                </div>
            <?php
                }
