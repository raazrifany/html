<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Tambahkan data produk ke dalam tabel keranjang belanja
        $queryAddToCart = "INSERT INTO cart_info (kategoriproduk_cart, namaproduk_cart, hargaproduk_cart, fotoproduk_cart) VALUES ('$product_id', '$product_name', '$product_price', '$product_image')";
    ...
    <div class="cart-container">
        ...
        ?>
                ...
                <div class="cart-item">
                    ...
                    <div class="total-price" id="totalPrice">Rp. <?php echo number_format($product_price, 0, ',', '.'); ?></div>
