...
<html>
    ...
    <body>
        ...
        <div class="navbar">
            ...
            <a style="float:right" class="img-menu" href="cart.php"><img src="dummy/shop-cart.png" /></a>
        </div>
                ...
                <div class="column  <?php echo $dataSeller[1]; ?>">
                    <div class="content">
                        ...
                        <form action="cart.php" method="post">
                            <input type="hidden" name="product_id" value="<?php echo $dataSeller[1]; ?>">
                            <input type="hidden" name="product_name" value="<?php echo $dataSeller[0]; ?>">
